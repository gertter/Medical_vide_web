...
// 音频转码worker
let recorderWorker = new Worker('/static/js/transformpcm.worker.js')
// 记录处理的缓存音频
let buffer = []
...
class IatRecorder {
  constructor (config) {
    ...
    this.appId = '5c1619cb'
    this.apiKey = '3cdbb4f07358b9b5f319b60110ee29f5'
    this.apiSecret = '1d73cf82da434785465e06a6ff974147'
  }
...
class IatTaste {
  ...
  setResult (data) {
    ...
    if (data.pgs === 'apd') {
      this.resultText = $('#result_output').val()
    }
    resultStr = this.resultText + str
    $('#result_output').val(resultStr)
  }
